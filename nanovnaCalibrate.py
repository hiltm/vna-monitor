...
##################################################
# This script can be run for calibrating
# the NanoVNA-F V2. It requires manual connections
##################################################
...
vna.set_sweep(start, stop, points) # it is important to perform the calibration in the frequency range intended to measure in
